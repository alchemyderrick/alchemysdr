 ...
 */
async function searchGoogleForXProfiles(companyHandle, maxUsers = 5, offset = 0) {
 ...
 * @param {number} offset - Offset to skip existing contacts (default 0)
 */
export async function searchUsersWithCompanyInBio(companyHandle, maxUsers = 5, offset = 0) {
  return await searchGoogleForXProfiles(companyHandle, maxUsers, offset);
}
