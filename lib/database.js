...
CREATE TABLE IF NOT EXISTS x_discovery_requests (
  id TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_x_discovery_status ON x_discovery_requests(status);
CREATE INDEX IF NOT EXISTS idx_x_discovery_created ON x_discovery_requests(created_at);
`);
