...
class PuppeteerManager {
  ...
  async getBrowser() {
    if (!this.browser || !this.browser.isConnected()) {
      ...
      // Set headless to false for debugging X searches
      const headless = false; // Always visible for now
      ...
      this.browser = await puppeteer.launch({
        ...
        args: [
          ...
          "--window-position=9999,9999", // Position off-screen so it doesn't steal focus
        ],
