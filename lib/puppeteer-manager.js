...
class PuppeteerManager {
  ...
  async getBrowser() {
    if (!this.browser || !this.browser.isConnected()) {
      ...
      // On cloud environments, use Puppeteer's bundled Chromium and skip userDataDir
      if (IS_CLOUD) {
        // Let Puppeteer use its bundled Chromium (downloaded during npm install)
        // Don't set executablePath - Puppeteer will find it automatically
        console.log(`[PUPPETEER] Using Puppeteer's bundled Chromium on cloud`);
